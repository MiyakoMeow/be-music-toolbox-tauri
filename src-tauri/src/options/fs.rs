...
#[tauri::command]
pub async fn is_file_same_content(file1: String, file2: String) -> Result<bool, String> {
...
#[tauri::command]
pub async fn is_dir_having_file(dir: String) -> Result<bool, String> {
...
#[tauri::command]
pub async fn remove_empty_folders(dir: String, dry_run: bool) -> Result<(), String> {
    let path = PathBuf::from(dir);
...
/// Returns an error if directory access fails
#[tauri::command]
pub async fn bms_dir_similarity(dir1: String, dir2: String) -> Result<f64, String> {
